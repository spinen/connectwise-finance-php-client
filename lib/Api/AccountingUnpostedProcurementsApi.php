...
/**
 * AccountingUnpostedProcurementsApi Class Doc Comment
 *
 * @category Class
 * @package  Spinen\ConnectWise\Clients\Finance
 * @author   Swagger Codegen team
...
class AccountingUnpostedProcurementsApi
{
    ...
    /**
     * Operation financeAccountingUnpostedprocurementCountGet
     *
     * 
     *
     ...
     */
    public function financeAccountingUnpostedprocurementCountGet($conditions = null)
    {
        list($response) = $this->financeAccountingUnpostedprocurementCountGetWithHttpInfo($conditions);
        return $response;
    }

    /**
     * Operation financeAccountingUnpostedprocurementCountGetWithHttpInfo
     *
     * 
     *
     * Spinen&#39;s PHP ConnectWise Client for Finance API generated by Swagger Code Generator.
     ...
     */
    public function financeAccountingUnpostedprocurementCountGetWithHttpInfo($conditions = null)
    {
        // parse inputs
        $resourcePath = "/finance/accounting/unpostedprocurement/count";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    /**
     * Operation financeAccountingUnpostedprocurementGet
     *
     * 
     *
     * Spinen&#39;s PHP ConnectWise Client for Finance API generated by Swagger Code Generator.
     ...
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     * @return \Spinen\ConnectWise\Clients\Finance\Spinen\ConnectWise\Clients\Finance\Model\UnpostedProcurement[]
     */
    public function financeAccountingUnpostedprocurementGet($conditions = null, $order_by = null, $childconditions = null, $customfieldconditions = null, $page = null, $page_size = null)
    {
        list($response) = $this->financeAccountingUnpostedprocurementGetWithHttpInfo($conditions, $order_by, $childconditions, $customfieldconditions, $page, $page_size);
        return $response;
    }

    /**
     * Operation financeAccountingUnpostedprocurementGetWithHttpInfo
     *
     * 
     *
     * Spinen&#39;s PHP ConnectWise Client for Finance API generated by Swagger Code Generator.
     ...
     * @param int $page_size  (optional)
     * @throws \Spinen\ConnectWise\Clients\Finance\ApiException on non-2xx response
     * @return array of \Spinen\ConnectWise\Clients\Finance\Spinen\ConnectWise\Clients\Finance\Model\UnpostedProcurement[], HTTP status code, HTTP response headers (array of strings)
     */
    public function financeAccountingUnpostedprocurementGetWithHttpInfo($conditions = null, $order_by = null, $childconditions = null, $customfieldconditions = null, $page = null, $page_size = null)
    {
        // parse inputs
        $resourcePath = "/finance/accounting/unpostedprocurement";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Spinen\ConnectWise\Clients\Finance\Spinen\ConnectWise\Clients\Finance\Model\UnpostedProcurement[]',
                '/finance/accounting/unpostedprocurement'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Spinen\ConnectWise\Clients\Finance\Spinen\ConnectWise\Clients\Finance\Model\UnpostedProcurement[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Spinen\ConnectWise\Clients\Finance\Spinen\ConnectWise\Clients\Finance\Model\UnpostedProcurement[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Spinen\ConnectWise\Clients\Finance\Spinen\ConnectWise\Clients\Finance\Model\Error', $e->getResponseHeaders());
    ...
    /**
     * Operation financeAccountingUnpostedprocurementIdGet
     *
     * 
     *
     * Spinen&#39;s PHP ConnectWise Client for Finance API generated by Swagger Code Generator.
     ...
     * @return \Spinen\ConnectWise\Clients\Finance\Spinen\ConnectWise\Clients\Finance\Model\UnpostedProcurement
     */
    public function financeAccountingUnpostedprocurementIdGet($id)
    {
        list($response) = $this->financeAccountingUnpostedprocurementIdGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation financeAccountingUnpostedprocurementIdGetWithHttpInfo
     *
     * 
     *
     * Spinen&#39;s PHP ConnectWise Client for Finance API generated by Swagger Code Generator.
     ...
     * @return array of \Spinen\ConnectWise\Clients\Finance\Spinen\ConnectWise\Clients\Finance\Model\UnpostedProcurement, HTTP status code, HTTP response headers (array of strings)
     */
    public function financeAccountingUnpostedprocurementIdGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling financeAccountingUnpostedprocurementIdGet');
        }
        // parse inputs
        $resourcePath = "/finance/accounting/unpostedprocurement/{id}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
